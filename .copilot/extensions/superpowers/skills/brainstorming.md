...
- **MemPalace:** Search `room_decisions` and `room_architecture` for prior decisions and patterns that may be relevant — use `mempalace_search` before proposing approaches.
