...
### Step 1.5: Recall Prior Knowledge

> **MemPalace:** Before executing, search relevant rooms (`room_architecture`, `room_payments`, `room_decisions`) for prior knowledge that may inform task execution — use `mempalace_search`.
