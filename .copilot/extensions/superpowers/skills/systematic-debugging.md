...
## Phase 0: Recall Prior Knowledge

> **MemPalace:** Before investigating, search `room_debugging` in `wing_escrowapp` for prior fixes to similar issues — use `mempalace_search`. Past root causes often illuminate current bugs.
